 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
                ...
                function showMoreActions(e) {
                    ...
                    if (targetType === "click") {
                        if (targetEvent.closest("[data-showmore-button]")) {
                            ...
                            const showMoreBlockParent = showMoreBlock.closest("[data-showmore-parent]");
                            ...
                            if (!showMoreContent.classList.contains("_slide")) {
                                ...
                                if (showMoreBlockParent) showMoreBlockParent.classList.toggle("showmore-active");
                            }
                        }
        ...
        if (inputMasks.length) {
            ...
            flsModules.inputmask = new Inputmask("+7 (999) 999-99-99").mask(inputMasks);
        }
        var nouislider = __webpack_require__(211);
        function rangeInit() {
            const rangeSlider = document.querySelectorAll("[data-range]");
            const rangeSliderPrice = document.querySelectorAll("[data-range-price]");
            const rangeSliderTemp = document.querySelectorAll("[data-range-temp]");
            if (rangeSlider.length) rangeSlider.forEach((rangeItem => {
                const priceStart = rangeItem.querySelector("[data-range-from]");
                const priceEnd = rangeItem.querySelector("[data-range-to]");
                priceStart.addEventListener("change", setPriceValues);
                priceEnd.addEventListener("change", setPriceValues);
                const item = rangeItem.querySelector("[data-range-item]");
                nouislider.create(item, {
                    start: [ +priceStart.dataset.rangeFrom, +priceEnd.dataset.rangeTo ],
                    connect: true,
                    range: {
                        min: [ +priceStart.dataset.rangeFrom ],
                        max: [ +priceEnd.dataset.rangeTo ]
                    }
                });
                item.noUiSlider.on("update", (function(values, handle) {
                    if (handle === 0) priceStart.value = Math.round(values[handle]);
                    if (handle === 1) priceEnd.value = Math.round(values[handle]);
                }));
            ...
            if (rangeSliderPrice.length) rangeSliderPrice.forEach((rangeItem => {
                const item = rangeItem.querySelector("[data-range-item]");
                nouislider.create(item, {
                    start: 145e4,
                    connect: "lower",
            ...
            if (rangeSliderTemp.length) rangeSliderTemp.forEach((rangeItem => {
                const item = rangeItem.querySelector("[data-range-item]");
                nouislider.create(item, {
                    start: 12,
                    connect: "lower",
                    ...
                    tooltips: {
                        to: function(numericValue) {
                            ...
                            if (numericValue >= 5 && numericValue <= 20) {
                                temp = `${Math.round(numericValue)} лет`;
                                return temp;
                            } else if (numericValue >= 25 && numericValue <= 30) {
                                temp = `${Math.round(numericValue)} лет`;
                                return temp;
                            } else if (numericValue >= 35 && numericValue <= 40) {
                                temp = `${Math.round(numericValue)} лет`;
                                return temp;
                            } else if (numericValue >= 45 && numericValue <= 50) {
                                temp = `${Math.round(numericValue)} лет`;
                                return temp;
                            } else if (numericValue >= 3 && numericValue <= 4) {
                                temp = `${Math.round(numericValue)} года`;
                                return temp;
                            } else if (numericValue >= 22 && numericValue <= 24) {
                                temp = `${Math.round(numericValue)} года`;
                                return temp;
                            } else if (numericValue >= 32 && numericValue <= 34) {
                                temp = `${Math.round(numericValue)} года`;
                                return temp;
                            } else if (numericValue >= 42 && numericValue <= 44) {
                                temp = `${Math.round(numericValue)} года`;
                                return temp;
                            } else {
                                temp = `${Math.round(numericValue)} год`;
                                return temp;
                            }
                        }
                    }
        ...
        let departmentsSlider;
        const mediaQuerySize = 767.98;
        function initSliders() {
            ...
            if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
                ...
                navigation: {
                    prevEl: ".reviews .arrows-slider__arrow_prev",
                    nextEl: ".reviews .arrows-slider__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".works-block__slider")) new core(".works-block__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".works-block .arrows-slider__arrow_prev",
                    nextEl: ".works-block .arrows-slider__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".sliders-card-products__slider")) new core(".sliders-card-products__slider", {
                modules: [ Navigation, Thumb, EffectFade, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
                ...
                thumbs: {
                    swiper: {
                        el: ".sliders-card-products-thumb__slider",
                        slidesPerView: 4,
                        spaceBetween: 10,
                        breakpoints: {
                            320: {
        ...
        function initSlidersMedia() {
            buildSliderr();
            if (document.querySelector(".our-departments__slider")) departmentsSlider = new core(".our-departments__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                observer: true,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".our-departments .arrows-slider__arrow_prev",
                    nextEl: ".our-departments .arrows-slider__arrow_next"
                },
                on: {}
            });
        }
        function windowResize() {
            ...
            if (windowWidth <= mediaQuerySize) initSlidersMedia(); else departmentsSliderDestroy();
        }
        function departmentsSliderDestroy() {
            if (departmentsSlider) {
                departmentsSlider.destroy(true, false);
                departmentsSlider = null;
            }
        }
        ...
        function imagesInit() {
            const images = document.querySelectorAll(".article__image.padding");
            if (images.length) images.forEach((image => {
                const imageItem = image.querySelector("img");
                const paddingValue = Math.round(imageItem.offsetHeight / imageItem.offsetWidth * 100);
                image.style.paddingBottom = `${paddingValue}%`;
                imageItem.classList.add("_image-init");
            }));
        }
        function gridInit() {
            if (document.querySelector(".services-design__items")) {
                const itemsGrid = new isotope(".services-design__items", {
                ...
                function documentActions(e) {
                    const targetElement = e.target;
                    if (targetElement.closest(".isotope-button")) {
                        const filterItem = targetElement.closest(".isotope-button");
                        const filterValue = filterItem.dataset.filter;
                        const filterActiveItem = document.querySelector(".isotope-button.active");
        ...
        da.init();
        window.addEventListener("load", script_windowLoad);
        document.addEventListener("click", documentActions);
        function script_windowLoad() {
            if (document.querySelector(".header").classList.contains("_header-black") && window.location.href === "http://192.168.0.4:8080/") document.querySelector(".header").classList.remove("_header-black");
            !document.body.hasAttribute("id") ? document.body.setAttribute("id", "page") : null;
            initMenuIcon();
        }
        function initMenuIcon() {
            if (isMobile.any()) {
                const menuArrow = document.querySelectorAll(".menu__arrow");
                if (menuArrow.length) menuArrow.forEach((el => {
        ...
        const script_scroll = new SmoothScroll(".scroll-top");
        const scrollButton = document.querySelector("[data-scroll]");
        const mainSection = document.querySelector(".main-block");
        const isVisibleButton = (y = 0) => {
            if (mainSection) {
                const mainSectionHeight = mainSection.offsetHeight;
                y >= mainSectionHeight / 2 ? scrollButton.classList.add("_scroll-active") : scrollButton.classList.remove("_scroll-active");
            }
        };
        window.addEventListener("scroll", (function(e) {
        ...
        flsModules.scrollTop = script_scroll;
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest("[data-showmore-parent]")) {
                const showMoreBlockParent = targetElement.closest("[data-showmore-parent]");
                const showMoreBlock = showMoreBlockParent.querySelector("[data-showmore]");
                const showMoreContent = showMoreBlockParent.querySelector("[data-showmore-content]");
                const showMoreSpeed = showMoreBlock.dataset.showmoreButton ? showMoreBlock.dataset.showmoreButton : "500";
                const hiddenHeight = getHeight(showMoreBlock, showMoreContent);
                if (!showMoreContent.classList.contains("_slide")) {
                    showMoreBlock.classList.contains("_showmore-active") ? _slideUp(showMoreContent, showMoreSpeed, hiddenHeight) : _slideDown(showMoreContent, showMoreSpeed, hiddenHeight);
                    showMoreBlock.classList.toggle("_showmore-active");
                    showMoreBlockParent.classList.toggle("showmore-active");
                }
            }
            if (targetElement.closest(".filter-services__item")) {
                const filterButton = targetElement.closest(".filter-services__item");
                const filterActiveButton = document.querySelector(".filter-services__item.active");
                const filterType = filterButton.dataset.filter;
                const filterElements = document.querySelectorAll(".services-completed-works__item");
                filterActiveButton.classList.remove("active");
                filterButton.classList.add("active");
                if (filterElements.length) filterElements.forEach((filterElement => {
                    console.log(filterElement.dataset.filter);
                    if (filterType === "*") filterElement.hidden = false; else if (filterElement.dataset.filter === filterType) {
                        filterElement.classList.add("_filter-active");
                        filterElement.hidden = false;
                    } else {
                        filterElement.classList.remove("_filter-active");
        ...
        if (window.location.pathname !== "/index.html") if (document.querySelector(".header")) document.querySelector(".header").classList.add("_header-black");
        const productCard = document.querySelectorAll(".product-card");
        if (productCard.length) productCard.forEach((card => {
            if (card.hasAttribute("data-old-price")) {
                const productPrice = card.querySelector(".product-card__price");
                productPrice.insertAdjacentHTML("afterbegin", `<div class="product-card__discount"><span>${card.dataset.oldPrice} ₽</span></div>`);
            }
        }));
        window["FLS"] = true;
        isWebp();
